...
# Frequencia d'events principals i comparativa basal
...
export2md(T3.1, caption = "Mortalitat Cardiovascular segons característiques basals i HR per cada factor")
...
export2md(T3.2, caption = "Característiques basals segons ECV i HR")
